...
import './Faq_service.css'

export default function Faq_service() {
  return <div>
      <div className="FAQServiceshere">
                            ...
                            <div className="innercol2faq mt-5">
                                ...
                                <div className="card maincardfaq">
                                    <div className="headingfaqcol2here">
                                        <h2>We are <span className='spantextcolor'> <strong className='topstrong'>top</strong>-rated </span> tax advisor in Islamabad and Rawalpindi.</h2>
                                    </div>
