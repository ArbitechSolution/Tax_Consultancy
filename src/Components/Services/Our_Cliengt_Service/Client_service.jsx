...
import './Client_service.css'

export default function Client_service() {
    return <div>
        <div className="OurClientsbg">
            <div className="container">
                <div className="Heading_sectionhere">
                    ...
                    <div className="satrticonandtext">

                        <p>Our 5 Star Rating Speaks for Itself </p>
                        <p>  <i class="fas fa-star staricon ms-2"></i> <i class="fas fa-star staricon"></i> <i class="fas fa-star staricon"></i> <i class="fas fa-star staricon"></i> <i class="fas fa-star staricon"></i></p>
                    </div>
                </div>
                ...
                {/* <div className="HeadingtextABH">
                    <h2>Why ABH Tax <span className='headingspancolor'>Consultants?</span> </h2>
